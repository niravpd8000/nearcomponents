...
const Notification = () => {
    ...
    return (
        <>
            <div
                className={"fixed w-full h-[100%] justify-between h-16 bg-white text-gray-700 border-b border-gray-200 z-10"}>
                <div
                    className="h-[60px] mb-[20px]  w-full text-[16px] mt-[19px] inline-block align-middle font-semibold text-[#414047] text-center border-b border-[#DFDFE0]">
                    Notifications
                </div>
                <div className={"px-[30px] mx-auto w-[362px]"}>
                    {notifications && notifications.map((notification, key) =>
                        <div key={key} className={"flex mb-[24px]"}>
                            ...
                            <div className={"block"}>
                                <div className={"font-medium font-[15px]"}>
                                    {notification.user &&
